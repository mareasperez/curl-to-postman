            ...
            @for (variable of hostVariables(); track variable.name) {
              <li class="var-item">
                ...
                <input
                  ...
                  (blur)="onHostBlur(variable.name, $event)"
                />
              </li>
            }
          </ul>
            ...
            @for (variable of tokenVariables(); track variable.name) {
              <li class="var-item">
                ...
                <input
                  class="var-input"
                  [value]="variable.value"
                  (blur)="onTokenBlur(variable.name, $event)"
                />
                <div class="token-actions">
                  <button type="button" class="mini-btn" (click)="sanitizeToken(variable.name)">
                    Sanitize
                  </button>
                  <button type="button" class="mini-btn" (click)="clearToken(variable.name)">
                    Clear
                  </button>
                  <button
                    type="button"
                    class="mini-btn danger"
                    (click)="toggleRemove(variable.name, !variable.removed)"
                  >
