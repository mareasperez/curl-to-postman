...
import { VariableAnalysis, ParsedRequest } from '@app/models';
...
describe('PostmanGeneratorService', () => {
  ...
  describe('parsePath', () => {
    ...
    it('should extract complex path from URL with variable', () => {
      const url =
        '{{auth_example_com_host}}/example.onmicrosoft.com/B2C_1A_SignUp_SignIn/api/CombinedSigninAndSignup/confirmed';
      const result = (service as any).parsePath(url);
  ...
  describe('generate', () => {
    it('should generate Postman collection with correct structure', () => {
      ...
      expect(result.info.schema).toBe(
